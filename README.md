...
A live chess arcade. Players sign in with Google, add friends, and play real-time chess in rooms that anyone can watch.

**Stack:** Angular 22 (standalone, zoneless, signals) · Tailwind CSS v4 · Firebase JS SDK v12 (Auth + Firestore) · [chessground](https://github.com/lichess-org/chessground) board · [chess.js](https://github.com/jhlywa/chess.js) rules engine
...
This is a private project with no license of its own. It bundles [chessground](https://github.com/lichess-org/chessground) (GPL-3.0-or-later) and the cburnett piece set that ships with it (GPL-2.0-or-later). The GPL applies when the app is distributed, which includes serving it from a public site: anyone who receives the app can ask for its source under the same license.
